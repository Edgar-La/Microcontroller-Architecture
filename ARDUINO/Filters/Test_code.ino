...
void loop(){
  ...
  if (customKey != NO_KEY){
        ...
        switch(Filtro){
          ...
          case '3':
          if (PASAR == 1) {  ALFA_BP_1 = obtener_ALFA("3) Band Pass", "Alfa inferior= ");  }
          else if (PASAR == 2){ALFA_BP_2 = obtener_ALFA("Digite ahora", "Alfa superior= ");  }
          ...
          case '4':
          if (PASAR == 1) {  ALFA_SB_1 = obtener_ALFA("4) Band Stop", "Alfa inferior= ");  }
          else if (PASAR == 2){ALFA_SB_2 = obtener_ALFA("Digite ahora", "Alfa superior= ");  }
          else if (PASAR == 3){   lcd.clear(); lcd.setCursor(2, 0); lcd.print("Ya estoy"); lcd.setCursor(2, 1); lcd.print("filtrando :)");   
...
float obtener_ALFA(String Tipo_filtro,String Alfa_igual)
{
          ...
          else
          {
            ...
            lcd.setCursor(17,1); lcd.print(ALFA_f_get); Serial.println(ALFA_f_get);
            PASAR++;
            ALFA_S = ""; //delay(30);
            return ALFA_f_get;
          }          
